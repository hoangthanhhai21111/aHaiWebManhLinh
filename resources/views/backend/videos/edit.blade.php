                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input name="title" type="text"
                                    class="form-control @error('title') is-invalid @enderror" value="{{ old('title') ?? $posts->title }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" class="form-control" value="" id="ckeditor1" rows="4"
                                style="resize: none">{{ old('content') ?? $posts->content}}</textarea>
                            @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="mb-2">
                                ...
                                <input type="radio" <?= $posts->status == '0' ? 'checked' : '' ?> id="html" name="status"  value="0" >
                                <label for="html">Ẩn </label>&nbsp
                                <input type="radio" <?= $posts->status == '1' ? 'checked' : '' ?> id="css" name="status" value="1">
