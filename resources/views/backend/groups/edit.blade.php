        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active">
                    <a href="{{ route('groups.index') }}"><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Trang danh
                        sách</a>
                </li>
            </ol>
        </nav>
                        ...
                        <form action="{{ route('groups.update', $group->id) }}" method="post">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="flatpickr01">Tên Nhóm</label> <input id="flatpickr01"
                                    type="text" class="form-control" name="name" value="{{ $group->name }}"
                                                ...
                                                <div
                                                    ...
                                                    <label class="switcher-control">
                                                        <input type="checkbox" @checked(in_array($role['id'], $userRoles)) name="roles[]"
                                                            class="switcher-input" value="{{ $role['id'] }}">
