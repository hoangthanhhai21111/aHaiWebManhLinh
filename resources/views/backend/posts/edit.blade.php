        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active">
                    <a href="{{ route('posts.index') }}"><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Trang quản lý bài Viết</a>
                </li>
            </ol>
        </nav>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input name="title" type="text"
                                    ...
                                    value="{{ old('title') ?? $posts->title}}" placeholder="Nhập tiêu đề bài viết">
                                @if ($errors->any())
